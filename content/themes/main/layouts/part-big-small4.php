<?php
	...
	$imageSizes = array('portrait-big3', 'portrait-small', 'portrait-small', 'portrait-small', 'portrait-small');
	...
	$leftSideHTML = '<div class="layout u-6/12 p">' .
		get_element_html($pageItems[0], $classTag, ($isInverted) ? $slideIndex++ + 4 : $slideIndex++) .
	'</div>';
	...
	'<div class="layout">' .
		'<div class="layout u-6/12 p">' .
			get_element_html($pageItems[3], $classTag, ($isInverted) ? $slideIndex++ -1 : $slideIndex++) .
		'</div>' .
		'<div class="layout u-6/12 p">' .
			get_element_html($pageItems[4], $classTag, ($isInverted) ? $slideIndex++ -1 : $slideIndex++) .
		'</div>' .
	'</div>'.
	'</div>';

<?php
	...
	$imageSizes = array('landscape', 'landscape', 'portrait-big2');
	...
	$leftSideHTML =	 '<div class="layout u-6/12">' .
		'<div class="layout p">' .
			get_element_html($pageItems[0], $classTag, ($isInverted) ? $slideIndex++ +1 : $slideIndex++) .
		'</div>' .
		'<div class="layout p">' .
	...
	$rightSideHTML = 	'<div class="layout u-6/12 p">' .
		get_element_html($pageItems[2], $classTag, ($isInverted) ? $slideIndex++ -2 : $slideIndex++) .
	'</div>';
?>
